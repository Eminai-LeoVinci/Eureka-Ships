...
class ShipHelmScreen(handler: ShipHelmScreenMenu, playerInventory: Inventory, text: Component) :
    ...
    // the 1.21.1 3D PoseStack (push/scale(s,s,1f)/pop) like drawBoxText below.
    ...
    // is a 3D PoseStack in 1.21.1 (push/scale(s,s,1f)/pop); divide screen coords by the scale to keep position.
